...
$(function(){
  ...
  //local vars, previous coords for the client, a random color, a boolean stating
  //if the client is drawing or not, and the time since we last told the server we were drawing.
  var prev = {};
